"""
Django settings for FlightsFilter project.
...
SECRET_KEY = 'django-insecure-x29(!h7^q6x@_ep6hd=koji2d0g1gabntq_@i2q&!9)#@ai!$x'
...
ROOT_URLCONF = 'FlightsFilter.urls'
...
WSGI_APPLICATION = 'FlightsFilter.wsgi.application'
